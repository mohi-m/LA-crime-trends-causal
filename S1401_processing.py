...
# Constants
INPUT_FOLDER = "data/raw-data/S1401"
OUTPUT_FILE = "data/processed-data/S1401_combined.csv"
...
def process_all_files(input_folder: str) -> pd.DataFrame:
    ...
    for area in LA_AREAS:
        ...
        area_df = area_df.resample("W").mean(numeric_only=True)  # Resample to weekly frequency
